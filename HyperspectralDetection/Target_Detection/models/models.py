...
class SpatialHTDFramework(torch.nn.Module):
    ...
    def __init__(self, 
        ...
        super(SpatialHTDFramework, self).__init__()
    ...
    def forward(self, x, ts):
        ...
        ts_feature = self.conv_ts(ts).unsqueeze(1) # b, 1, 128
...
class SSHTDFramework(torch.nn.Module):
    ...
    def __init__(self, 
                  ...
                  classes: int = 1,
                  activation: Optional[Union[str, callable]] = None):
        super(SSHTDFramework, self).__init__()
